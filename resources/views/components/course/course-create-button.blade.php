...
<div x-data="{ showModal:  @json($errors->any()) }">
    ...
    <div @click="showModal = true"
        class="flex items-center justify-center rounded-lg bg-white shadow-2xl h-60 w-60 p-4 hover:cursor-pointer relative group transform transition-transform duration-200 hover:scale-105">
        <div class="flex items-center justify-center border-dashed border-gray-800 border-2  w-11/12  rounded-lg"
            style="height:91.666667%">
    ...
    <div x-show="showModal" class=" fixed z-40 inset-0 flex items-center justify-center bg-gray-800  bg-opacity-75 ">
        <div class="bg-white rounded-lg p-8 w-full max-w-md " @click.away="showModal = false">
            ...
            <form action="/admin/courses" method="POST" dir="rtl">
                @csrf
                @method("POST")
                <div class="mt-4">
                ...
                <div class="my-4">
                    ...
                    <x-forms.selectinput class=" mb-5 mt-3" name="class" />
