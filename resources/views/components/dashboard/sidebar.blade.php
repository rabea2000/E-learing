...
@php
    ...
    if(request()->is("admin/users")){
        ...
        $placdholder = " search for user " ; 
      
    }
    elseif (request()->is("courses/create")) {
      $placdholder = "أبحث عن كورس " ; 
    }

    elseif (request()->is("files")) {
      $placdholder = " أبحث عن ملف " ; 
    }
    else {
      $placdholder = "أبحث " ; 
    }
...
@endphp
   ...
   <div class=" sticky top-0 z-10 border-b-2 border-gray-300">
      <nav class= "  bg-white text-white h-16 shadow-gray-600 flex items-center justify-between w-full mr-auto lg:max-w-[calc(100%-15rem)]" dir="rtl">
         <div>
            <button   id="menuBtn"  aria-controls="default-sidebar" type="button" class="inline-flex items-center p-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
               ...
               <div class="inline-block mr-4  max-md:hidden">
                     <div class="relative ">
                        ...
                        <input type="text" name="search" id="table-search-users"  class="block p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 " placeholder={{$placdholder}}>
                      </form>
                     </div>
         ...
         <div class="flex items-center mx-10">
            ...
            <h1 class="inline text-black font-bold mr-5 text-lg">Admin</h1>
         </div>
      </nav>
   </div>
   ...
   <aside id="sidebar" class="fixed top-0 right-0 z-40 w-60 h-screen  inset-y-0  lg:translate-x-0 transform translate-x-full transition-transform duration-300 lg:block "
    aria-label="Sidebar"
    > 
           ...
           <ul class="space-y-2 font-medium">
            ...
            <button id="closeBtn"  class="absolute top-0 left-0  text-white w-10 h-10  lg:hidden  rounded   hover:bg-gray-600">
             ...
             <li>              
               ...
               <li>
                  <a href="/admin" class="flex items-center p-2  mr-4 rounded-lg text-white  hover:bg-gray-700 group">
               ...
               <li>
                  <a href="/admin/users" class="flex items-center p-2 mr-4 rounded-lg text-white  hover:bg-gray-700 group">
                     <svg class="w-5 h-5  transition duration-75 text-gray-400  group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
                        <path d="M14 2a3.963 3.963 0 0 0-1.4.267 6.439 6.439 0 0 1-1.331 6.638A4 4 0 1 0 14 2Zm1 9h-1.264A6.957 6.957 0 0 1 15 15v2a2.97 2.97 0 0 1-.184 1H19a1 1 0 0 0 1-1v-1a5.006 5.006 0 0 0-5-5ZM6.5 9a4.5 4.5 0 1 0 0-9 4.5 4.5 0 0 0 0 9ZM8 10H5a5.006 5.006 0 0 0-5 5v2a1 1 0 0 0 1 1h11a1 1 0 0 0 1-1v-2a5.006 5.006 0 0 0-5-5Z"/> 
                     </svg>
                     <span class="ms-3"> إدارة المستخدمين</span>
                  </a>
               </li>

               <li>
                  <a href="/admin/courses/create" class="flex items-center p-2 mr-4 rounded-lg text-white  hover:bg-gray-700 group">
                     <svg class="w-5 h-5  transition duration-75 text-gray-400  group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
                        <path d="M16.975 11H10V4.025a1 1 0 0 0-1.066-.998 8.5 8.5 0 1 0 9.039 9.039.999.999 0 0 0-1-1.066h.002Z"/>
                        <path d="M12.5 0c-.157 0-.311.01-.565.027A1 1 0 0 0 11 1.02V10h8.975a1 1 0 0 0 1-.935c.013-.188.028-.374.028-.565A8.51 8.51 0 0 0 12.5 0Z"/>
                     </svg>
                     <span class="ms-3"> إدارة الدورات</span>
                  </a>
               </li>

               <li>
                  <a href="/admin/files/create" class="flex items-center p-2 mr-4 rounded-lg text-white  hover:bg-gray-700 group">
                     <svg class="w-5 h-5  transition duration-75 text-gray-400  group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
                        <path d="M16.975 11H10V4.025a1 1 0 0 0-1.066-.998 8.5 8.5 0 1 0 9.039 9.039.999.999 0 0 0-1-1.066h.002Z"/>
                        <path d="M12.5 0c-.157 0-.311.01-.565.027A1 1 0 0 0 11 1.02V10h8.975a1 1 0 0 0 1-.935c.013-.188.028-.374.028-.565A8.51 8.51 0 0 0 12.5 0Z"/>
                     </svg>
                     <span class="ms-3"> إدارة الملفات</span>
                  </a>
               </li>

               <li>
                  <a href="/admin/files" class="flex items-center p-2 mr-4 rounded-lg text-white  hover:bg-gray-700 group">
                     <svg class="w-5 h-5  transition duration-75 text-gray-400  group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
                        <path d="M16.975 11H10V4.025a1 1 0 0 0-1.066-.998 8.5 8.5 0 1 0 9.039 9.039.999.999 0 0 0-1-1.066h.002Z"/>
                        <path d="M12.5 0c-.157 0-.311.01-.565.027A1 1 0 0 0 11 1.02V10h8.975a1 1 0 0 0 1-.935c.013-.188.028-.374.028-.565A8.51 8.51 0 0 0 12.5 0Z"/>
                     </svg>
                     <span class="ms-3"> الملفات</span>
                  </a>
               </li>
            
               <li>
                  <a href="/" class="flex items-center p-2  mr-4 rounded-lg text-white  hover:bg-gray-700 group">
                     <svg class="w-5 h-5  transition duration-75 text-gray-400  group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
                        <path d="M16.975 11H10V4.025a1 1 0 0 0-1.066-.998 8.5 8.5 0 1 0 9.039 9.039.999.999 0 0 0-1-1.066h.002Z"/>
                        <path d="M12.5 0c-.157 0-.311.01-.565.027A1 1 0 0 0 11 1.02V10h8.975a1 1 0 0 0 1-.935c.013-.188.028-.374.028-.565A8.51 8.51 0 0 0 12.5 0Z"/>
                     </svg>
                     <span class="ms-3"> صفحة الموقع </span>
                  </a>
               </li>
